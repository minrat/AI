...
class Game(Frame):
    def __init__(self):
        ...
        self.grid()
        # 设置标题
        self.master.title('2048 游戏（Tkinter 版本）')
        # 按键事件（按键按下）监听
        self.master.bind("<Key>", self.key_down)
        # 方向键组合
        self.commands = {c.KEY_UP: action.up,
                         c.KEY_DOWN: action.down,
                         c.KEY_LEFT: action.left,
                         c.KEY_RIGHT: action.right
                         }
